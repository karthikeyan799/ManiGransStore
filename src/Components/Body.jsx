                ...
                <div className='bodyContainer d-flex text-white'>
                    <div className='col-12 col-sm-12 px-5 col-md-6 bodyContent'>
                        ...
                        <div className='silkBtn'>
                            ...
                            <button className='col btn learnMoremodern my-1 bg-white text-black'>LEARN MORE</button>
                            <button className='col btn learnMoremodern my-1 bg-black'>ADD TO CART</button>
                        </div>
                    </div>
