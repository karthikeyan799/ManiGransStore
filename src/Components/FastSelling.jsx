    ...
    return (
        <div className='container-fluid text-center'>
            ...
            <div className='fastCart '>
                <div className='col-xl-2 col col-md-4 col-lg-2 col-sm-6 cart cart1 cartSide'>
                ...
                <div className='col-xl-2 col col-md-4 col-lg-2 col-sm-6 cart cart1'>
                ...
                <div className='col-xl-2 col col-md-4 col-lg-2 col-sm-6 cart cartSide cart1'>
                ...
                <div className='col-xl-2 col-md-4 col-lg-2 col-sm-3 col cart cart2 cartSde d-none d-sm-none d-md-flex'>
                    <div className='img6  my-4'></div>
                ...
                <div className='col-xl-2 col-md-3 col-lg-2 col-sm-3 col cart cart3 '>
                    <div className='img7  my-4'></div>
                ...
                <div className='col-xl-2 col-md-3 col-lg-2 col-sm-3 col cart '>
                    <div className='img12  my-4'></div>
            ...
            <button className='learnMore  my-5 px5 py2' style={{ backgroundColor: "yellowgreen" }}>VIEW ALL FAST SELLING</button>
        </div>
    )
}
