        ...
        <div className='container text-center'>
            ...
            <div className='fastCart '>
                <div className='col-xl-2 col cart cart1'>
                    <div className='img1 my-4 bg-dark text-center'>
                    </div>
                ...
                <div className='col-xl-2 col cart cart1'>
                    <div className='img2 my-4 bg-dark'></div>
                    {/* <img className='my-4 bg-dark' src="../src/assets/Mani shop/froks1.png" alt="" /> */}
                    <h6>GIRLS WEAR</h6>
                    <h6><b> GOWNS & FROKS </b></h6>
                    <h5><i className='bi bi-currency-rupee'></i>1,200</h5>
                </div>
                <div className='col-xl-2 col cart cart1 img3'>
                    <img className='my-4 bg-dark' src="../src/assets/Mani shop/kuta1.png" alt="" />
                    <h6>MENS WEAR</h6>
                    <h6><b> KURTHA</b></h6>
                    <h5><i className='bi bi-currency-rupee'></i>2,400</h5>
                </div>
                <div className='col-xl-2 col cart cart1 img4'>
                ...
                <div className='col-xl-2 col cart cart3 img7'>
                ...
                <div className='col-xl-2 col cart cart3 img8'>
                ...
                <div className='col-xl-2 col cart cart3 img9'>
                ...
                <div className='col-xl-2 col cart cart3 img10'>
                ...
                <div className='col-xl-2 col cart cart3 img11'>
                ...
                <div className='col-xl-2 col cart img12'>
