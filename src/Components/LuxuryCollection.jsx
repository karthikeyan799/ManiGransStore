    ...
    return (
        <div className='my5'>
            ...
            <div className=' d-flex luxury my-5'>
                ...
                <div className='col-12 flex-column gap2 flex-sm-row silkDiv col-sm-12 col-md-12 col-lg-6 '>
                    <div className='silk col-6 col-sm-6 text-center col-md-6 col-lg-6 p-2'>
                    ...
                    <div className='silk col-6 overflow-hidden col-sm-6 text-center col-md-6 col-lg-6 p-2'>
