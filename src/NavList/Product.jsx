...
import { addtoCart, fetchCart, removeCart } from '../Slices/ManiSlice';
...
export default function Product({ title, image }) {
    ...
    return (
        <div className='container my-5 '>
            <div className=' d-flex justify-content-betwen my-5 gap-5'>
                <img src={index.image} className='col-5 border shadow rounded-2 p-1 me-5' alt="" />

                <div className='col-4 p-3 border d-flex flex-column gap-2 ustify-content-between ms-5'>
            ...
            <div>
                ...
                <div className='d-flex flex-row justify-content-center w-75 h-75'>

                    {without.map((w) => {
                        return (
                            <div className='d-flex flex-column bg-primary rounded-3 m-3 w-100 p-2 py-4' key={w.id} onClick={() => navigate(`/product/${w.id}`)}>
